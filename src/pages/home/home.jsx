...
const HomePage = () => {
  ...
  useEffect(() => {
    ...
    // Request Firebase data if array is empty, does not exist, or local storage was last updated more than 5 days ago.
    if (!Array.isArray(repos.data) || !repos.data.length || Date.now() - repos.epoch > daysToMs(5)) {
      firebaseRequest();
    }
      ...
      <Box>
        <Container maxWidth="pf" sx={{ mb: 3, pt: 3 }}>
          ...
          <Typography color="text.secondary" sx={{ mb: 1 }}>
            Hello! I&#39;m a Web Developer currently located in San Ramon, CA. In my free time I like working on
            creative projects of all shapes and sizes. You can find a collection of side projects I maintain listed
            below.
          </Typography>
          <Social />
